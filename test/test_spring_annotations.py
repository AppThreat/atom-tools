...
def test_java_type_to_schema_primitives():
    ...
    assert _java_type_to_schema("java.lang.Long") == {
        "type": "integer",
        "format": "int64",
    }
    assert _java_type_to_schema("long") == {"type": "integer", "format": "int64"}
    assert _java_type_to_schema("java.lang.Double") == {
        "type": "number",
        "format": "double",
    }
...
def test_java_type_to_schema_collections():
    ...
    assert _java_type_to_schema("java.util.UUID") == {
        "type": "string",
        "format": "uuid",
    }
...
def test_extract_annotation_string_value_named_attribute():
    assert (
        _extract_annotation_string_value('@RequestHeader(value = "X-Auth-Token")')
        == "X-Auth-Token"
    )
...
def test_properties_from_getters_deduplicates():
    ...
    arg_to_calls = [
        {
            "callName": "getEmail",
            "resolvedMethod": "X.getEmail:java.lang.String(0)",
            "paramTypes": [],
            "returnType": "java.lang.String",
        },
        {
...
def test_properties_from_getters_ignores_non_getters():
    ...
    arg_to_calls = [
        {
            "callName": "setFoo",
            "resolvedMethod": "X.setFoo(1)",
            "paramTypes": [],
            "returnType": "void",
        },
        {
            "callName": "get",
            "resolvedMethod": "X.get(0)",
            "paramTypes": [],
            "returnType": "ANY",
        },
        {
            "callName": "getName",
            "resolvedMethod": "X.getName:java.lang.String(0)",
            "paramTypes": [],
            "returnType": "java.lang.String",
        },
    ]
    ...
    usages = [
        {
            "targetObj": {
                "name": "body",
                "typeFullName": "com.example.ChargeRequest",
                "label": "PARAM",
            },
            "invokedCalls": [
                {
    ...
    usages = [
        {
            "targetObj": {
                "name": "resultDto",
                "typeFullName": "com.example.ResultDTO",
                "label": "LOCAL",
            },
            "invokedCalls": [],
            "argToCalls": [],
...
def test_extract_response_dto_key_from_constructor():
    ...
    usages = [
        {
            "targetObj": {
                "name": "inviteValidationResponseDTO",
                "typeFullName": "ai.levo.iam.dto.InviteValidationResponseDTO",
                "label": "LOCAL",
            },
            "invokedCalls": [
                {
                    ...
                    "resolvedMethod": None,
                    "paramTypes": [
                        "ai.levo.iam.dto.InviteValidationResponseDTO",
                        "ANY",
                    ],
                    "returnType": "ANY",
                }
