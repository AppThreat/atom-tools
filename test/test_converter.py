...
def test_convert_usages(
    java_usages_1, java_usages_2, js_usages_1, js_usages_2, py_usages_1, py_usages_2
):
...
def test_filter_calls():
    ...
    assert filter_calls(queried_calls, resolved_methods) == {
        "resolved_methods": {
            '@RequestMapping(value = "/current", method = RequestMethod.GET)': {
                "calls": [
                    {
...
def test_java(java_usages_1):
    ...
    assert methods == {
        ...
        "account-service/src/main/java/com/piggymetrics/account/client/StatisticsServiceClientFallback.java": [
            "@Override",
            "LOGGER",
        ...
        "account-service/src/main/java/com/piggymetrics/account/controller/AccountController.java": [
        ...
        "account-service/src/main/java/com/piggymetrics/account/controller/ErrorHandler.java": [
        ...
        "account-service/src/main/java/com/piggymetrics/account/domain/Currency.java": [
            "EUR",
            "RUB",
            "USD",
        ...
        "account-service/src/main/java/com/piggymetrics/account/domain/TimePeriod.java": [
            "DAY",
            "HOUR",
            "MONTH",
            "QUARTER",
        ...
        "account-service/src/main/java/com/piggymetrics/account/repository/AccountRepository.java": [
        ...
        "auth-service/src/main/java/com/piggymetrics/auth/config/OAuth2AuthorizationConfig.java": [
            "@Override",
        ...
        "auth-service/src/main/java/com/piggymetrics/auth/config/WebSecurityConfig.java": [
            "<unresolvedNamespace>.disable:<unresolvedSignature>(0)",
            "@Bean",
            "@Override",
        ...
        "auth-service/src/main/java/com/piggymetrics/auth/service/security/MongoUserDetailsService.java": [
            "@Override",
            "com.piggymetrics.auth.repository.UserRepository.findById:java.util.Optional(java.lang.Object)",
        ...
        "notification-service/src/main/java/com/piggymetrics/notification/NotificationServiceApplication.java": [
            "@Bean",
        ...
        "notification-service/src/main/java/com/piggymetrics/notification/client/AccountServiceClient.java": [
            "@RequestMapping(method "
            "= "
            "RequestMethod.GET, "
            "value "
        ...
        "notification-service/src/main/java/com/piggymetrics/notification/config/ResourceServerConfig.java": [
            "@Bean",
            '@ConfigurationProperties(prefix = "security.oauth2.client")',
        ...
        "notification-service/src/main/java/com/piggymetrics/notification/domain/Frequency.java": [
            "MONTHLY",
            "QUARTERLY",
            "WEEKLY",
        ...
        "notification-service/src/main/java/com/piggymetrics/notification/domain/NotificationSettings.java": [
            "active",
        ...
        "notification-service/src/main/java/com/piggymetrics/notification/domain/NotificationType.java": [
            "BACKUP",
            "REMIND",
            "attachment",
        ...
        "notification-service/src/main/java/com/piggymetrics/notification/repository/converter/FrequencyReaderConverter.java": [
            "@Override",
            "com.piggymetrics.notification.domain.Frequency.withDays:com.piggymetrics.notification.domain.Frequency(int)",
            "com.piggymetrics.notification.repository.converter.FrequencyReaderConverter.<init>:void()",
        ],
        "notification-service/src/main/java/com/piggymetrics/notification/repository/converter/FrequencyWriterConverter.java": [
            "@Override",
            "com.piggymetrics.notification.domain.Frequency.getDays:int()",
            "com.piggymetrics.notification.repository.converter.FrequencyWriterConverter.<init>:void()",
        ],
        "notification-service/src/main/java/com/piggymetrics/notification/service/EmailServiceImpl.java": [
            "@Override",
            "com.piggymetrics.notification.domain.NotificationType.getAttachment:java.lang.String()",
            "com.piggymetrics.notification.domain.NotificationType.getSubject:java.lang.String()",
            "com.piggymetrics.notification.domain.NotificationType.getText:java.lang.String()",
        ...
        "notification-service/src/main/java/com/piggymetrics/notification/service/RecipientService.java": [
            "com.piggymetrics.notification.service.RecipientService.findByAccountName:com.piggymetrics.notification.domain.Recipient(java.lang.String)",
            "com.piggymetrics.notification.service.RecipientService.findReadyToNotify:java.util.List(com.piggymetrics.notification.domain.NotificationType)",
            "com.piggymetrics.notification.service.RecipientService.save:com.piggymetrics.notification.domain.Recipient(java.lang.String,com.piggymetrics.notification.domain.Recipient)",
        ],
        ...
        "statistics-service/src/main/java/com/piggymetrics/statistics/StatisticsApplication.java": [
            "@Bean"
        ],
        ...
        "statistics-service/src/main/java/com/piggymetrics/statistics/client/ExchangeRatesClientFallback.java": [
            "@Override",
        ...
        "statistics-service/src/main/java/com/piggymetrics/statistics/config/ResourceServerConfig.java": [
            "@Bean",
            "sso",
        ],
        ...
        "statistics-service/src/main/java/com/piggymetrics/statistics/domain/Account.java": [
        ...
        "statistics-service/src/main/java/com/piggymetrics/statistics/domain/Currency.java": [
            "EUR",
            "RUB",
            "USD",
            "com.piggymetrics.statistics.domain.Currency.getBase:com.piggymetrics.statistics.domain.Currency()",
        ],
        "statistics-service/src/main/java/com/piggymetrics/statistics/domain/ExchangeRatesContainer.java": [
            "@Override",
            "base",
            "com.piggymetrics.statistics.domain.ExchangeRatesContainer.<init>:void()",
        ...
        "statistics-service/src/main/java/com/piggymetrics/statistics/domain/Item.java": [
            "amount",
        ...
        "statistics-service/src/main/java/com/piggymetrics/statistics/domain/Saving.java": [
            "amount",
            "capitalization",
        ...
        "statistics-service/src/main/java/com/piggymetrics/statistics/domain/TimePeriod.java": [
            "DAY",
            "HOUR",
            "MONTH",
            "QUARTER",
        ...
        "statistics-service/src/main/java/com/piggymetrics/statistics/domain/timeseries/DataPoint.java": [
        ...
        "statistics-service/src/main/java/com/piggymetrics/statistics/domain/timeseries/DataPointId.java": [
            "@Override",
            "account",
        ...
        "statistics-service/src/main/java/com/piggymetrics/statistics/domain/timeseries/ItemMetric.java": [
            "<operator>.notEquals",
            "@Override",
            "amount",
        ...
        "statistics-service/src/main/java/com/piggymetrics/statistics/domain/timeseries/StatisticMetric.java": [
            "EXPENSES_AMOUNT",
            "INCOMES_AMOUNT",
            "SAVING_AMOUNT",
        ],
        "statistics-service/src/main/java/com/piggymetrics/statistics/repository/DataPointRepository.java": [
            "com.piggymetrics.statistics.repository.DataPointRepository.findByIdAccount:java.util.List(java.lang.String)"
        ],
        "statistics-service/src/main/java/com/piggymetrics/statistics/repository/converter/DataPointIdReaderConverter.java": [
            "<operator>.cast",
            "@Override",
        ...
        "statistics-service/src/main/java/com/piggymetrics/statistics/repository/converter/DataPointIdWriterConverter.java": [
            "@Override",
            "FIELDS",
        ...
        "statistics-service/src/main/java/com/piggymetrics/statistics/service/ExchangeRatesService.java": [
        ...
        "statistics-service/src/main/java/com/piggymetrics/statistics/service/StatisticsServiceImpl.java": [
            "@Override",
            "com.google.common.collect.ImmutableMap.of:com.google.common.collect.ImmutableMap(java.lang.Object,java.lang.Object,java.lang.Object,java.lang.Object,java.lang.Object,java.lang.Object)",
            "com.piggymetrics.statistics.domain.Account.getExpenses:java.util.List()",
            "com.piggymetrics.statistics.domain.Account.getIncomes:java.util.List()",
        ...
        "statistics-service/src/main/java/com/piggymetrics/statistics/service/security/CustomUserInfoTokenServices.java": [
            "<operator>.cast",
            "<operator>.indexAccess",
            "@Override",
            '@SuppressWarnings({ "unchecked" })',
...
def test_js(js_usages_1):
    ...
    assert js_usages_1.target_line_nums == {
        "frontend/src/app/score-board/score-board.component.ts": {
            "__whatwg.console:warn": [168],
...
def rust_usages_1():
    ...
    return OpenAPI("openapi3.0.1", "rust", "test/data/rust-axum-sample-rusi.json")
