...
def test_openapi_class(java_usages_1, java_usages_2):
    openapi = OpenAPI('openapi3.1.0', 'java',
        'test/data/java-piggymetrics-usages.json')
    assert java_usages_1.openapi_version == '3.1.0'
    assert java_usages_1.origin_type == 'java'

    assert java_usages_2.openapi_version == '3.0.1'
    assert java_usages_2.origin_type == 'java'


def test_endpoints_to_openapi(
        java_usages_1,
        java_usages_2,
        js_usages_1,
        js_usages_2,
    ...
    assert java_usages_2.endpoints_to_openapi() == {
        'info': {'title': 'Atom Usages', 'version': '1.0.0'},
        'openapi': '3.0.1',
    ...
    assert js_usages_1.endpoints_to_openapi() == {
        ...
        'paths': {'/': {}, '/*/*': {}, '/.well-known/security.txt': {},
                  ...
                  '/b2b/v2/orders': {}, '/dataerasure': {},
                  '/encryptionkeys': {}, '/encryptionkeys/{file}': {},
                  '/file-upload': {}, '/frontend/dist/frontend': {}, '/ftp': {},
                  '/ftp(?!/quarantine)/{file}': {},
    ...
    assert js_usages_2.endpoints_to_openapi() == {
        'info': {'title': 'Atom Usages', 'version': '1.0.0'},
        'openapi': '3.0.1', 'paths': {'/': {}, '/allocations/{userId}': {},
                                      ...
                                      '/signup': {}, '/tutorial': {},
                                      '/tutorial/a1': {}}}
    assert py_usages_1.endpoints_to_openapi() == {
        'info': {'title': 'Atom Usages', 'version': '1.0.0'},
        'openapi': '3.0.1', 'paths': {'/scan': {}}}
    assert py_usages_2.endpoints_to_openapi() == {
        'info': {'title': 'Atom Usages', 'version': '1.0.0'},
        'openapi': '3.0.1', 'paths': {'/auth/google': {}, '/logout': {}}}
...
def test_convert_usages(
    ...
    assert java_usages_1.convert_usages() == [
        ...
        '/current', '/latest', '/statistics/{accountName}', '/uaa/users',
        '/{accountName}', '/{name}'
    ]
    assert java_usages_2.convert_usages() == ['/', '/Digester/sec',
        '/Digester/vuln', '/DocumentBuilder/Sec', '/DocumentBuilder/vuln',
        '/DocumentBuilder/xinclude/sec', '/DocumentBuilder/xinclude/vuln',
        '/DocumentHelper/vuln', '/HttpSyncClients/vuln',
        '/HttpURLConnection/sec', '/HttpURLConnection/vuln', '/IOUtils/sec',
        '/ImageIO/sec', '/Jsoup/sec', '/ProcessBuilder', '/SAXBuilder/sec',
        '/SAXBuilder/vuln', '/SAXParser/sec', '/SAXParser/vuln',
        '/SAXReader/sec', '/SAXReader/vuln', '/XMLReader/sec',
        '/XMLReader/vuln', '/aa', '/any', '/appInfo', '/application/javascript',
        '/classloader', '/codeinject', '/codeinject/host', '/codeinject/sec',
        '/commonsHttpClient/sec', '/createToken', '/deserialize',
        '/dnsrebind/vuln', '/exclued/vuln', '/fastjsonp/getToken', '/forward',
        '/getName', '/getToken', '/httpclient/sec', '/hutool/vuln', '/index',
        '/jdbc/ps/vuln', '/jdbc/sec', '/jdbc/vuln', '/jscmd', '/log4j',
        '/login', '/logout', '/mybatis/orderby/sec04',
        '/mybatis/orderby/vuln03', '/mybatis/sec01', '/mybatis/sec02',
        '/mybatis/sec03', '/mybatis/vuln01', '/mybatis/vuln02', '/noproxy',
        '/object2jsonp', '/okhttp/sec', '/openStream', '/path_traversal/sec',
        '/path_traversal/vul', '/pic', '/post', '/postgresql', '/proxy',
        '/readxlsx', '/redirect', '/reflect', '/rememberMe/security',
        '/rememberMe/vuln', '/request/sec', '/restTemplate/vuln1',
        '/restTemplate/vuln2', '/runtime/exec', '/safe', '/safecode', '/sec',
        '/sec/array_indexOf', '/sec/checkOrigin', '/sec/checkReferer',
        '/sec/corsFilter', '/sec/crossOrigin', '/sec/httpCors',
        '/sec/originFilter', '/sec/webMvcConfigurer', '/sec/yarm',
        '/sendRedirect', '/sendRedirect/sec', '/setHeader', '/spel/vuln',
        '/status', '/stored/show', '/stored/store', '/upload',
        '/upload/picture', '/urlConnection/sec', '/urlConnection/vuln',
        '/velocity', '/vuln/contains', '/vuln/crossOrigin',
        '/vuln/emptyReferer', '/vuln/endsWith', '/vuln/mappingJackson2JsonView',
        '/vuln/origin', '/vuln/referer', '/vuln/regex', '/vuln/setHeader',
        '/vuln/url_bypass', '/vuln/yarm', '/vuln01', '/vuln02', '/vuln03',
        '/vuln04', '/vuln05', '/vuln06', '/websocket/cmd', '/websocket/proxy',
        '/xmlReader/sec', '/xmlReader/vuln', '/xmlbeam/vuln', '/xstream']
    assert js_usages_1.convert_usages() == ['/', '/*/*',
        '/.well-known/security.txt', '/Invalidemail/passwordcannotbeempty',
        '/api-docs', '/api/Addresss', '/api/Addresss/{id}', '/api/BasketItems',
        ...
        '/assets/public/images/products', '/assets/public/images/uploads',
        '/b2b/v2', '/b2b/v2/orders', '/dataerasure', '/encryptionkeys',
        '/encryptionkeys/{file}', '/file-upload', '/frontend/dist/frontend',
        '/ftp', '/ftp(?!/quarantine)/{file}', '/ftp/quarantine/{file}',
        '/metrics', '/profile', '/profile/image/file', '/profile/image/url',
        '/promotion', '/redirect', '/rest/2fa/disable', '/rest/2fa/setup',
        ...
        'continueCode}', '/rest/country-mapping', '/rest/deluxe-membership',
        '/rest/image-captcha', '/rest/languages', '/rest/memories',
        '/rest/order-history', '/rest/order-history/{'
                               'id}/delivery-status',
        '/rest/order-history/orders', '/rest/products/{id}/reviews',
        '/rest/products/reviews', '/rest/products/search',
        '/rest/repeat-notification', '/rest/saveLoginIp',
        ...
        '/security.txt', '/snippets', '/snippets/{challenge}',
        '/snippets/fixes', '/snippets/fixes/{key}', '/snippets/verdict',
        '/solve/challenges/server-side', '/support/logs',
        '/support/logs/{file}',
        '/the/devs/are/so/funny/they/hid/an/easter/egg/within/the/easter/egg',
        '/this/page/is/hidden/behind/an/incredibly/high/paywall/that/could'
        '/only/be/unlocked/by/sending/1btc/to/us',
        '/video',
        '/we/may/also/instruct/you/to/refuse/all/reasonably/necessary'
        '/responsibility']
    assert js_usages_2.convert_usages() == ['/', '/allocations/{userId}',
        '/app/assets/favicon.ico', '/benefits', '/contributions', '/dashboard',
        '/learn', '/login', '/logout', '/memos', '/profile', '/research',
        '/signup', '/tutorial', '/tutorial/a1']
    assert py_usages_1.convert_usages() == ['/scan']
    assert py_usages_2.convert_usages() == ['/auth/google', '/logout']


def test_not_supported(java_usages_1):
    with pytest.raises(NotImplementedError):
        java_usages_1.convert_reachables()

    with pytest.raises(NotImplementedError):
        java_usages_1.create_paths_item()

    with pytest.raises(NotImplementedError):
        java_usages_1.get_template()
